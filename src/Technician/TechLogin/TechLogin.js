        ...
        return ( 
                    ...
                    <div className='whole' style={{marginLeft:"15%", marginTop:"10%"}}>
                         ...
                         <form action="" onSubmit={loginSubmit}  style={{ float: "left", marginLeft: "8%" }}>
                            <div>
                            <input onChange={handleInput} value={loginInput.email} name='email' style={{ width: "100%", marginTop: "20px", borderRadius: "15px", paddingTop:"6px",paddingBottom:"6px",paddingLeft:"10px",border:"1px solid lightgray" }} placeholder="Email" type="email" />
                            </div>
                            <p style={{color:"red"}}>{errors.email}</p>
                            <div>
                            <input onChange={handleInput} value={loginInput.password} name='password' style={{ width: "100%", marginTop: "20px", borderRadius: "15px", paddingTop:"6px",paddingBottom:"6px",paddingLeft:"10px",border:"1px solid lightgray" }} placeholder="password" type="password" />
                            </div>
