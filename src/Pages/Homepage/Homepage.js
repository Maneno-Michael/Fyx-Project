...
function Homepage() {
  return (
              ...
              <div id = "form-holder">
                 ...
                 <p className = "text-center text-warning">Request for Fyx Best Rated Professionals</p>
                    ...
                    <div className="text-centered" >
                        <p className = "small font-weight-bold" >Register to be a technician for FYX <br> 
    ...
    <div id="multi-item-example" className="carousel slide carousel-multi-item" data-ride="carousel" data-interval="10000">
                      ...
                      <div className="row pt-4 ml-4">
                          <div className="col-md-4 item">
                             <h3 id = "contactUs">Contact Us</h3>
                              <ul>
                                  <li><i className = "fa fa-map-marker fa-2x mr-2"></i> GA House, 2nd Floor. UpperHill</li><br>
                                  <li><img id = "iconPhone" src = "assets/icons/icons8-phone-24.png" height="20px" width="20px"/>  0794636596/0709596105</li></br>
